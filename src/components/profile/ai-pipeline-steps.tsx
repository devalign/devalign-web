...
export default function AIPipelineSteps() {
  ...
  return (
    <div className="rounded-2xl border border-border bg-card p-6 md:p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-4 items-start relative">
        {steps.map((step, idx) => {
          ...
          return (
            <React.Fragment key={step.num}>
              ...
              <div className="flex flex-col items-center text-center space-y-3 relative group">
                <div className={`flex h-12 w-12 items-center justify-center rounded-xl ${step.color} shadow-sm group-hover:scale-105 transition-transform duration-200`}>
