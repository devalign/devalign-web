...
import { ChevronRight, Lightbulb, Sparkles, TrendingUp, X } from 'lucide-react';
      ...
      steps: [
        {
          ...
          justification:
            'Docker aparece en el 74% de las ofertas asociadas a tu especialidad de Data Engineering y Backend. Su conocimiento es un prerrequisito para orquestación y despliegue cloud.',
      ...
      steps: [
        {
          ...
          justification:
            'Kubernetes es la herramienta estándar del mercado TI peruano para la administración de microservicios en la nube. Las ofertas de arquitecturas de datos modernas exigen orquestación automatizada.',
        ...
        },
        {
          ...
          justification:
            'La arquitectura de microservicios representa el 82% de la demanda en ofertas para ingenieros Mid/Senior. Entender la comunicación distribuida es crítico.',
      ...
      steps: [
        {
          ...
          justification:
            'AWS es el proveedor de nube dominante en el mercado local con 58% de las ofertas exigiendo experiencia cloud directa. Ideal para orquestar pipelines de datos.',
        ...
        },
        {
          ...
          justification:
            'La integración continua garantiza despliegues seguros y ágiles. Redundancia de errores manuales reducida a cero.',
    ...
    <div className="min-h-screen bg-background p-6">
      ...
      <div className="max-w-4xl mx-auto mb-8">
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Una ruta secuencial optimizada mediante reglas de asociación para reducir tus brechas con
          el mercado.
        </p>
      </div>
          ...
          <Card className="shadow-lg shadow-black/5 border-border bg-card">
            ...
            <CardContent className="space-y-3">
              ...
              <p className="text-[10px] text-muted-foreground leading-normal">
                Las ofertas para la especialidad <strong>Data Engineering</strong> se han
                incrementado en los últimos 6 meses en Lima metropolitana.
              </p>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-start gap-2.5">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-muted-foreground leading-normal">
                    Los perfiles Backend Java con <strong>Kubernetes</strong> y <strong>AWS</strong>{' '}
                    tienen salarios promedios <strong>32% más altos (2.3x)</strong> en el mercado
                    peruano comparado con perfiles tradicionales sin experiencia cloud.
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <div className="flex-1 overflow-y-auto py-6 space-y-6 min-h-0">
              ...
              <div className="space-y-2 p-4 rounded-xl border border-primary/20 bg-primary/5">
                ...
                <p className="text-[9px] text-muted-foreground leading-normal">
                  ...
                  analizando 450+ ofertas del mercado local. Indica una alta co-ocurrencia de estas
                  habilidades.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-[9px] text-muted-foreground leading-normal">
                  ...
                  <strong>{activeStep.skill}</strong> en ofertas de especialidades técnicas TI
